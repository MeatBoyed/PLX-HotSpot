        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    blnk_wallet_id = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_profiles_AspNetUsers_identity_user_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    first_visit_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    last_visit_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_site_memberships", x => x.id);
                    table.ForeignKey(
                        name: "FK_site_memberships_profiles_profile_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_site_memberships_profile_id_site_id",
                table: "site_memberships",
                columns: new[] { "profile_id", "site_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_site_memberships_site_id",
                table: "site_memberships",
                column: "site_id");

            migrationBuilder.CreateIndex(
                name: "IX_site_memberships_tenant_id",
                table: "site_memberships",
                column: "tenant_id");
        }
