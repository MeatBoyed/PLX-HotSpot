...
export const mockSites: Site[] = [
  ...
  { id: 'site_joburg_main', tenantId: 'tenant_joburg', name: 'Main Hall',
    ...
    status: 'active', marketingOptIn: false, radiusCalledStationIds: [],
    createdAt: '2024-01-20T08:00:00Z', updatedAt: '2024-12-01T10:00:00Z' },
  { id: 'site_joburg_cafe', tenantId: 'tenant_joburg', name: 'Café Area',
    ...
    status: 'active', marketingOptIn: false, radiusCalledStationIds: [],
    createdAt: '2024-01-20T08:00:00Z', updatedAt: '2024-11-15T09:30:00Z' },
  { id: 'site_joburg_parking', tenantId: 'tenant_joburg', name: 'Parking Garage',
    ...
    status: 'suspended', marketingOptIn: false, radiusCalledStationIds: [],
    createdAt: '2024-01-20T08:00:00Z', updatedAt: '2024-10-05T14:00:00Z' },
  ...
  { id: 'site_kwa_beach', tenantId: 'tenant_kwamaimai', name: 'Beach Front',
    ...
    status: 'active', marketingOptIn: false, radiusCalledStationIds: [],
    createdAt: '2024-02-15T09:00:00Z', updatedAt: '2024-12-05T11:00:00Z' },
  { id: 'site_kwa_restaurant', tenantId: 'tenant_kwamaimai', name: 'Restaurant',
    ...
    status: 'maintenance', marketingOptIn: false, radiusCalledStationIds: [],
    createdAt: '2024-02-15T09:00:00Z', updatedAt: '2024-12-08T08:00:00Z' },

  // Sandton City
  { id: 'site_sandton_l1', tenantId: 'tenant_sandton', name: 'Level 1',
    ssid: 'SandtonCity-L1', domain: 'l1.sandtoncity.com', sortOrder: 1,
    status: 'active', marketingOptIn: false, radiusCalledStationIds: [],
    createdAt: '2024-03-10T07:30:00Z', updatedAt: '2024-12-10T15:00:00Z' },
  ...
  { id: 'site_zoo_entrance', tenantId: 'tenant_pta_zoo', name: 'Main Entrance',
    ...
    status: 'active', marketingOptIn: false, radiusCalledStationIds: [],
    createdAt: '2024-04-25T11:00:00Z', updatedAt: '2024-11-20T10:00:00Z' },
