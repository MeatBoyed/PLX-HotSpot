        ...
        <Card className="w-full" style={{ backgroundColor: theme.surfaceCard }}>
            <CardHeader>
                <CardTitle className="flex flex-col items-start justify-start gap-2">
                    ...
                    <h5 className="text-[1.5625rem] font-bold" style={{ color: theme.textPrimary }}>
                        R8.00<span className="text-sm font-medium" style={{ color: theme.textTertiary }}>/month</span>
                    </h5>
                </CardTitle>
                <CardDescription className="flex flex-col items-start justify-start gap-4 ">
                    <div className="w-full flex items-start justify-start gap-1">
                        <h6 className="font-medium text-sm" style={{ color: theme.textSecondary }}>50 Hrs</h6>
                        <Dot className="w-5 h-5" style={{ color: theme.textSecondary }} />
                        <h6 className="font-medium text-sm" style={{ color: theme.textSecondary }}>2GB</h6>
                    </div>
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Button
                    ...
                    style={{
                        ...
                        '--tw-hover-bg': theme.brandPrimaryHover
