  ...
  return (
    <div className="relative flex flex-col items-center max-w-md w-full h-screen overflow-hidden"
      ...
      <div className="relative z-10 w-full flex flex-col items-center px-5 pt-6 pb-10">
        <div className="flex items-center gap-3 px-4 py-2.5 rounded-full mb-5 w-full justify-between"
        ...
        <div className="text-center">
          <p className="text-xs font-bold tracking-widest uppercase mb-1 opacity-70" style={{ color: theme.textPrimary }}>
            Dashboard
          </p>
      ...
      <div className="relative z-10 w-full flex-1 px-5 pb-4 pt-2 overflow-y-auto"
        ...
        <div className="rounded-2xl p-3 flex flex-col gap-2 mb-4 shadow-lg"
          style={{ background: 'rgba(255,255,255,0.85)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.6)' }}>
          <div className="flex justify-between items-center">
            <span className="text-sm" style={{ color: theme.textPrimary }}>Free plan</span>
            <span className="font-semibold text-sm" style={{ color: theme.textPrimary }}>R0.00</span>
          </div>
          <div className="text-2xl font-bold" style={{ color: theme.brandPrimary }}>
            1.41 <span className="text-base">GB</span>
          </div>
          <div className="text-xs mb-1" style={{ color: theme.textPrimary }}>left of 2.0 GB</div>
          ...
          <div className="flex justify-between text-xs pt-1" style={{ color: theme.textPrimary }}>
