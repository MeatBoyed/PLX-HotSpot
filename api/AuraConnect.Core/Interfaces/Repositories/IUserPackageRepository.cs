...
namespace AuraConnect.Core.Interfaces.Repositories
{
    public interface IUserPackageRepository
    {
        ...
        Task<UserPackage?> GetLatestByProfileAndSiteAsync(string profileId, string siteId, CancellationToken cancellationToken = default);
        Task UpdateAsync(UserPackage userPackage, CancellationToken cancellationToken = default);
